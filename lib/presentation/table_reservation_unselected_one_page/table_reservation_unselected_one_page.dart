import 'models/table_reservation_unselected_one_model.dart';
import 'package:arest/core/app_export.dart';
import 'package:arest/widgets/custom_outlined_button.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg_provider/flutter_svg_provider.dart' as fs;
import 'provider/table_reservation_unselected_one_provider.dart';

// ignore_for_file: must_be_immutable
class TableReservationUnselectedOnePage extends StatefulWidget {
  const TableReservationUnselectedOnePage({Key? key})
      : super(
          key: key,
        );

  @override
  TableReservationUnselectedOnePageState createState() =>
      TableReservationUnselectedOnePageState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => TableReservationUnselectedOneProvider(),
      child: TableReservationUnselectedOnePage(),
    );
  }
}

class TableReservationUnselectedOnePageState
    extends State<TableReservationUnselectedOnePage>
    with AutomaticKeepAliveClientMixin<TableReservationUnselectedOnePage> {
  @override
