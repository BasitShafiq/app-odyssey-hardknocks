...
class Dish2ItemWidget extends StatelessWidget {
  Dish2ItemWidget(
    this.dish2ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  Dish2ItemModel dish2ItemModelObj;
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    dish2ItemModelObj.foodName!,
                    style: CustomTextStyles.labelLargeManrope,
                  ),
                  SizedBox(height: 8.v),
                  Text(
                    dish2ItemModelObj.details!,
          ...
          Align(
            ...
            child: Container(
              ...
              child: CustomImageView(
                imagePath: dish2ItemModelObj?.foodImage,
                height: 90.v,
                width: 97.h,
                alignment: Alignment.centerLeft,
              ),
